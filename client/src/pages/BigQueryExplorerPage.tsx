      ...
      <AppLayout title="BigQuery Explorer">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-sm">
            ...
            <h2 className="text-lg font-semibold text-foreground mb-2">No BigQuery credentials configured</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Add a GCP service account credential to start browsing BigQuery data.
            </p>
            <Link
              to="/credentials"
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded hover:bg-primary/90 transition-colors"
            >
              Go to Credentials
            </Link>
          </div>
